// ======================================================================
// 2020-Control-Scheme.v generated from TopDesign.cysch
// 02/06/2020 at 20:40
...
module top ;
    ...
    Debouncer_v1_0 Buttons_1_8 (
        ...
        .either(Net_175[7:0]),
        .pos(Net_176[7:0]));
    defparam Buttons_1_8.EitherEdgeDetect = 0;
    defparam Buttons_1_8.NegEdgeDetect = 0;
    defparam Buttons_1_8.PosEdgeDetect = 0;
    defparam Buttons_1_8.SignalWidth = 8;

    Debouncer_v1_0 Buttons_9_11 (
        .d(Net_177[2:0]),
        .clock(lnClck),
        .q(Net_207[2:0]),
        .neg(Net_179[2:0]),
        .either(Net_180[2:0]),
        .pos(Net_181[2:0]));
    defparam Buttons_9_11.EitherEdgeDetect = 0;
    defparam Buttons_9_11.NegEdgeDetect = 0;
    defparam Buttons_9_11.PosEdgeDetect = 0;
    defparam Buttons_9_11.SignalWidth = 3;
	...
	wire [7:0] tmpOE__Pin_1_8_net;
	wire [7:0] tmpIO_7__Pin_1_8_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1_8_net;
	electrical [0:0] tmpSIOVREF__Pin_1_8_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_1_8
		 (.oe(tmpOE__Pin_1_8_net),
		  .y({8'b0}),
		  .fb({Net_172[7:0]}),
		  .io({tmpIO_7__Pin_1_8_net[7:0]}),
		  .siovref(tmpSIOVREF__Pin_1_8_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [2:0] tmpOE__Pin_9_11_net;
	wire [2:0] tmpIO_2__Pin_9_11_net;
	wire [0:0] tmpINTERRUPT_0__Pin_9_11_net;
	electrical [0:0] tmpSIOVREF__Pin_9_11_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_9_11
		 (.oe(tmpOE__Pin_9_11_net),
		  .y({3'b0}),
		  .fb({Net_177[2:0]}),
		  .io({tmpIO_2__Pin_9_11_net[2:0]}),
		  .siovref(tmpSIOVREF__Pin_9_11_net),
		  .interrupt({tmpINTERRUPT_0__Pin_9_11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_9_11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

    CyStatusReg_v1_90 Status_1_8 (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_193),
        .status_bus(Net_194[7:0]));
    defparam Status_1_8.Bit0Mode = 0;
    defparam Status_1_8.Bit1Mode = 0;
    defparam Status_1_8.Bit2Mode = 0;
    defparam Status_1_8.Bit3Mode = 0;
    defparam Status_1_8.Bit4Mode = 0;
    defparam Status_1_8.Bit5Mode = 0;
    defparam Status_1_8.Bit6Mode = 0;
    defparam Status_1_8.Bit7Mode = 0;
    defparam Status_1_8.BusDisplay = 1;
    defparam Status_1_8.Interrupt = 0;
    defparam Status_1_8.MaskValue = 0;
    defparam Status_1_8.NumInputs = 8;

    CyStatusReg_v1_90 Status_9_11 (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_205),
        .status_bus(Net_207[2:0]));
    defparam Status_9_11.Bit0Mode = 0;
    defparam Status_9_11.Bit1Mode = 0;
    defparam Status_9_11.Bit2Mode = 0;
    defparam Status_9_11.Bit3Mode = 0;
    defparam Status_9_11.Bit4Mode = 0;
    defparam Status_9_11.Bit5Mode = 0;
    defparam Status_9_11.Bit6Mode = 0;
    defparam Status_9_11.Bit7Mode = 0;
    defparam Status_9_11.BusDisplay = 1;
    defparam Status_9_11.Interrupt = 0;
    defparam Status_9_11.MaskValue = 0;
    defparam Status_9_11.NumInputs = 3;
